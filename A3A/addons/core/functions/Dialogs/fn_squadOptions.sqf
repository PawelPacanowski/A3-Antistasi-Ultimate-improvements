...
{_costs = _costs + ((server getVariable _x) get "currentCost"); _costHR = _costHR +1} forEach FactionGet(reb,"groupSquad");
...
_costs = 0;
_costHR = 0;
{_costs = _costs + ((server getVariable _x) get "currentCost"); _costHR = _costHR +1} forEach FactionGet(reb,"groupSquadEng");
...
_costs = 0;
_costHR = 0;
{_costs = _costs + ((server getVariable _x) get "currentCost"); _costHR = _costHR +1} forEach FactionGet(reb,"groupSquadSupp");
